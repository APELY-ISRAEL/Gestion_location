		...
		<header id="home" class="welcome-hero">
										...
										<div class="col-sm-7">
											<div class="single-welcome-hero">
												<div class="welcome-hero-txt">
													<h4>Grande Collection de luxe</h4>
													<h2>la marque Rolls Royce </h2>
													<p>
								...
								<div class="welcome-hero-content">
									<div class="row">
										<div class="col-sm-7">
											<div class="single-welcome-hero">
												<div class="welcome-hero-txt">
													<h4>Grande collection de voiture a sport</h4>
													<h2>la marque Bugatti</h2>
													<p>
														Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiuiana smod tempor  ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip.
													</p>
													<div class="packages-price">
								...
								<div class="welcome-hero-content">
									<div class="row">
										<div class="col-sm-7">
											<div class="single-welcome-hero">
												<div class="welcome-hero-txt">
													<h4>Grande collection de voiture de famille</h4>
													<h2> la marque Hyundai</h2>
													<p>
														Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiuiana smod tempor  ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip.
													</p>
													<div class="packages-price">
			...
			<div class="top-area">
				        ...
				        <div class="container">
				            ...
				            <div class="attr-nav">
				                <ul>
				                  ...
				                  <li class="dropdown">
				                        <a href="{{ route('profile.edit') }}" class="dropdown-toggle" data-toggle="dropdown" >
              ...
              <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <li class="nav-setting">
				            <a href="{{ route('logout') }}" onclick="event.preventDefault();this.closest('form').submit();"><span>Déconnexion</span></a>
                        </li>
                                        @endguest
				                	</li><!--/.search-->
				                </ul>
				            ...
				            <div class="navbar-header">
				                ...
				                <a class="navbar-brand" href="#">Israel<span>'Cars</span>.</a>
				            ...
				            <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
				                <ul class="nav navbar-nav navbar-center" data-in="fadeInDown" data-out="fadeOutUp">
				                    <li class=" scroll active"><a href="#home">Maison</a></li>
				                    <li class="scroll"><a href="#new-arrivals">nouvelles arrrivage</a></li>
				                    <li class="scroll"><a href="#feature">Caracteristique</a></li>
...
Voir les données</a>
		...
		<section id="feature" class="feature">
			<div class="container">
				<div class="section-header">
					<h2>Caracteristique des produits</h2>
				</div><!--/.section-header-->
				...
				<div class="hm-footer-details">
					<div class="row">
						<div class=" col-md-3 col-sm-6 col-xs-12">
							<div class="hm-footer-widget">
								...
								<div class="hm-foot-menu">
									<ul>
										<li><a href="#">A propos</a></li><!--/li-->
										<li><a href="#">contacter nous</a></li><!--/li-->
										<li><a href="#">nouveau</a></li><!--/li-->
										<li><a href="#">Stoke</a></li><!--/li-->
									</ul><!--/ul-->
								</div><!--/.hm-foot-menu-->
						...
						<div class=" col-md-3 col-sm-6 col-xs-12">
							<div class="hm-footer-widget">
								<div class="hm-foot-title">
									<h4>Notre Consideration</h4>
								</div><!--/.hm-foot-title-->
								<div class="hm-foot-menu">
									<ul>
										<li><a href="#">Ma consideration</a></li><!--/li-->
										<li><a href="#">Envie</a></li><!--/li-->
										<li><a href="#">Communauté</a></li><!--/li-->
										<li><a href="#">ordre d'histoire</a></li><!--/li-->
										<li><a href="#">mon panier</a></li><!--/li-->
									</ul><!--/ul-->
								</div><!--/.hm-foot-menu-->
							</div><!--/.hm-footer-widget-->
						</div><!--/.col-->
						<div class=" col-md-3 col-sm-6  col-xs-12">
							<div class="hm-footer-widget">
								...
								<div class="hm-foot-para">
									<p>
										Souscrire pour obtenir les dernieres nouvelles de mis a jour et information.
									</p>
								</div><!--/.hm-foot-para-->
